 ...
 * @author Flavien
 */
class CustomPreloader extends NMEPreloader {private static inline var OUTLINE_BAR_COLOR:Int = 0x000000;
	...
	private function updateProgressBar(percent:Float):Void {
		...
		progress.graphics.drawRoundRect(0, 0, outline.width, outline.height * 0.5, progressBarRadiusBorder, progressBarRadiusBorder);
